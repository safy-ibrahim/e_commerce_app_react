    ...
    <>
      <div className="p-3 hover:shadow-md hover:border hover:rounded-lg hover:shadow-green-700 transition duration-300">
        ...
        <p className="text-center">
          <i
            className={`fas fa-heart text-lg cursor-pointer ${
              isWishlist ? "text-red-600" : "text-gray-400"
            }`}
        ...
        <button
          ...
          className="mt-3 w-full text-center rounded bg-customColor1 text-white p-2 hover:bg-green-600"
        >
